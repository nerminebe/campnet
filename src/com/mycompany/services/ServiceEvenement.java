...
public class ServiceEvenement {
 ...
 public boolean addEvenement(Evenement t) {
        ...
        String url = Statics.BASE_URL+"/addEvenement?nom=" + t.getNom()+ "&photo="+t.getPhoto()+"&description="+t.getDescription()+"&lieu="+t.getLieu()+"&prix="+t.getPrix(); //création de l'URL
...
System.out.println(url);
     ...
     public void deletEvenement(float id){   
        ...
        Dialog d = new Dialog();
            ...
            {             
                ...
                req.setUrl(Statics.BASE_URL+"/deleteEvenement?id="+id);
   ...
   public boolean updateEvenement(Evenement t) {
        String url = Statics.BASE_URL+"/updateEvenement?nom=" + t.getNom()+"&photo="+t.getPhoto()+"&description="+t.getDescription()+"&lieu="+t.getLieu()+"&prix="+t.getPrix()+"&id="+t.getId(); //création de l'URL
        System.out.println(url);
        req.setUrl(url);// Insertion de l'URL de notre demande de connexion
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
